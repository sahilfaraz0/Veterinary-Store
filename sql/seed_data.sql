INSERT INTO public.vet_doctors (id, name, created_at)
VALUES
  ('doc-001', 'Dr. Demo Vet Specialist', '2026-06-01T08:00:00Z'),
  ('doc-002', 'Chief Administrator', '2026-06-01T08:00:00Z')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name;

INSERT INTO public.products (id, barcode, name, category, unit, pack_size, min_stock_level, description, requires_prescription, image_url)
VALUES
...
INSERT INTO public.stock_batches (id, product_id, batch_number, supplier_name, purchase_price, selling_price, initial_quantity, current_quantity, expiry_date, received_date, status)
VALUES
...
VALUES
  ('owner-001', 'Demo Cattle Farm', '+1 (555) 010-1001', 'client.cattle@demo.pk', '100 Demo Farm Road, Suite 101'),
  ('owner-002', 'Demo Dairy Ranch', '+1 (555) 010-1002', 'client.dairy@demo.pk', '200 Demo Sector Way, Suite 102'),
  ('owner-003', 'Demo Equine Club', '+1 (555) 010-1003', 'client.equine@demo.pk', '300 Demo Club Road, Suite 103'),
  ('owner-004', 'Demo Pet Care Client', '+1 (555) 010-1004', 'client.pet@demo.pk', '400 Demo Plaza, Suite 104')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name,
...
INSERT INTO public.pets (id, owner_id, name, species, breed, age_years, weight_kg, notes)
VALUES
...
INSERT INTO public.transactions (id, receipt_number, total_amount, net_profit, customer_name, customer_phone, payment_method, cashier_id, cashier_name, prescription_verified, vet_doctor_name, transaction_date)
VALUES
  ('txn-101', 'INV-20260515-001', 6450.00, 2250.00, 'Demo Cattle Farm', '+1 (555) 010-1001', 'Cash', 'b2222222-2222-2222-2222-222222222222', 'Demo Cashier (Staff)', true, 'Chief Administrator', '2026-05-15T10:30:00Z'),
  ('txn-102', 'INV-20260520-002', 3400.00, 1200.00, 'Demo Dairy Ranch', '+1 (555) 010-1002', 'Card', 'b2222222-2222-2222-2222-222222222222', 'Demo Cashier (Staff)', false, null, '2026-05-20T14:15:00Z'),
  ('txn-103', 'INV-20260605-003', 10400.00, 3400.00, 'Demo Equine Club', '+1 (555) 010-1003', 'Online', 'a1111111-1111-1111-1111-111111111111', 'Chief Administrator', true, 'Chief Administrator', '2026-06-05T11:00:00Z'),
  ('txn-104', 'INV-20260618-004', 5550.00, 2250.00, 'Demo Pet Care Client', '+1 (555) 010-1004', 'Cash', 'b2222222-2222-2222-2222-222222222222', 'Demo Cashier (Staff)', false, null, '2026-06-18T16:45:00Z'),
  ('txn-105', 'INV-20260702-005', 8600.00, 3000.00, 'Demo Vet Services', '+1 (555) 010-1005', 'Card', 'b2222222-2222-2222-2222-222222222222', 'Demo Cashier (Staff)', true, 'Dr. Demo Vet Specialist', '2026-07-02T09:20:00Z'),
  ('txn-106', 'INV-20260710-006', 4800.00, 1950.00, 'Demo Poultry Care', '+1 (555) 010-1006', 'Cash', 'b2222222-2222-2222-2222-222222222222', 'Demo Cashier (Staff)', false, null, '2026-07-10T13:10:00Z')
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.transaction_items (id, transaction_id, product_id, batch_id, quantity, unit_price, unit_cost, subtotal)
VALUES
...
INSERT INTO public.audit_logs (id, user_id, user_name, role, action_type, description, target_id, created_at)
VALUES
  ('log-seed-01', 'a1111111-1111-1111-1111-111111111111', 'Chief Administrator', 'Admin', 'SYSTEM_INIT', 'Initialized Veterinary Store & Clinic Phase 2 Database Schema & RLS Policies', 'system', '2026-07-01T08:00:00Z'),
  ('log-seed-02', 'b2222222-2222-2222-2222-222222222222', 'Demo Cashier (Staff)', 'Cashier', 'SALE_PROCESSED', 'Processed POS Checkout Receipt INV-20260710-006 (Cash) for Rs. 4,800.00', 'txn-106', '2026-07-10T13:10:00Z')
